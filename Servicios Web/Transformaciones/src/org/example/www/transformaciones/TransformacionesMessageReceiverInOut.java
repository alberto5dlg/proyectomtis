        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("fechas".equals(methodName)){
                ...
                org.example.www.transformaciones.FechasResponse fechasResponse13 = null;
	                        org.example.www.transformaciones.Fechas wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), fechasResponse13, false, new javax.xml.namespace.QName("http://www.example.org/Transformaciones/",
                                                    "fechas"));
                                    } else 

            if("facturaToPDF".equals(methodName)){
                
                org.example.www.transformaciones.FacturaToPDFResponse facturaToPDFResponse15 = null;
	                        org.example.www.transformaciones.FacturaToPDF wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               facturaToPDFResponse15 =
                                                   
                                                   
                                                         skel.facturaToPDF(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), facturaToPDFResponse15, false, new javax.xml.namespace.QName("http://www.example.org/Transformaciones/",
                                                    "facturaToPDF"));
                                    } else 

            if("jSONtoXML".equals(methodName)){
                
                org.example.www.transformaciones.JSONtoXMLResponse jSONtoXMLResponse17 = null;
	                        org.example.www.transformaciones.JSONtoXML wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), jSONtoXMLResponse17, false, new javax.xml.namespace.QName("http://www.example.org/Transformaciones/",
                                                    "jSONtoXML"));

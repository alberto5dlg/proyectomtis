...
/**
 * ObtenerListaVuelosResponse.java
 *
 ...
 */
            ...
            /**
            *  ObtenerListaVuelosResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerListaVuelosResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerListaVuelosResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerListaVuelosResponse",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerListaVuelosResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerListaVuelosResponse object =
                new ObtenerListaVuelosResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerListaVuelosResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerListaVuelosResponse)org.example.www.listaespera.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

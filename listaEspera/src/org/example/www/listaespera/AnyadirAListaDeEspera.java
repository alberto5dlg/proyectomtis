 ...
 */
            ...
            /**
            *  AnyadirAListaDeEspera bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AnyadirAListaDeEspera
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":anyadirAListaDeEspera",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "anyadirAListaDeEspera",
    ...
    public static class Factory{
        ...
        */
        public static AnyadirAListaDeEspera parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AnyadirAListaDeEspera object =
                new AnyadirAListaDeEspera();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"anyadirAListaDeEspera".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AnyadirAListaDeEspera)org.example.www.listaespera.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

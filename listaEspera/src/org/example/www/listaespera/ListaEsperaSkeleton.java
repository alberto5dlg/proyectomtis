      ...
      (  ObtenerClientesANotificar ent)
{
         ...
         try {
            ...
            res.setCorreos(ListaEspera.listaCorreos);
            res.setMensajes(ListaEspera.listaMensajes);
         } catch (Exception e) {
            e.printStackTrace();
        }
         return res;
...
public ObtenerListaVuelosResponse obtenerListaVuelos(ObtenerListaVuelos ent){
 ...
 try {
        ...
        res.setIdVuelo1(ListaEspera.listadoVuelos1);
        res.setIdVuelos2(ListaEspera.listadoVuelos2);
    } catch (Exception e) {
        e.printStackTrace();
    }
 return res;

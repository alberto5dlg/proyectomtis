 ...
 */
            ...
            /**
            *  HayClientesEnEspera bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class HayClientesEnEspera
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":hayClientesEnEspera",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "hayClientesEnEspera",
    ...
    public static class Factory{
        ...
        */
        public static HayClientesEnEspera parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            HayClientesEnEspera object =
                new HayClientesEnEspera();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"hayClientesEnEspera".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (HayClientesEnEspera)org.example.www.listaespera.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

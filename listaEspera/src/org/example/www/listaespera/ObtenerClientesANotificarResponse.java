...
/**
 * ObtenerClientesANotificarResponse.java
 *
 ...
 */
            ...
            /**
            *  ObtenerClientesANotificarResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerClientesANotificarResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerClientesANotificarResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerClientesANotificarResponse",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerClientesANotificarResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerClientesANotificarResponse object =
                new ObtenerClientesANotificarResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerClientesANotificarResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerClientesANotificarResponse)org.example.www.listaespera.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

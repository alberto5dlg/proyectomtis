                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getCorreo(){
                              ...
                              /**
                               * validate the array for Correo
                               */
                              protected void validateCorreo(java.lang.String[] param){
                             ...
                             */
                             public void addCorreo(java.lang.String param){
                                   if (localCorreo == null){
                                   localCorreo = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localCorreo);
                               list.add(param);
                               this.localCorreo =
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localCorreoTracker){
                             if (localCorreo!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localCorreo.length;i++){
                                        
                                            if (localCorreo[i] != null){
                                        
                                                writeStartElement(null, namespace, "correo", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCorreo[i]));
                                  ...
                                  for (int i = 0;i < localCorreo.length;i++){
                                         ...
                                         if (localCorreo[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "correo"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCorreo[i]));
                                          } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerClientesResponse".equals(type)){
                                ...
                                return (ObtenerClientesResponse)org.example.www.listaespera.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","correo").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setCorreo((java.lang.String[])

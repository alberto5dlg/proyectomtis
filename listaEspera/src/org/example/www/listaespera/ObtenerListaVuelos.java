 ...
 */
            ...
            /**
            *  ObtenerListaVuelos bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerListaVuelos
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerListaVuelos",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerListaVuelos",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerListaVuelos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerListaVuelos object =
                new ObtenerListaVuelos();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerListaVuelos".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerListaVuelos)org.example.www.listaespera.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

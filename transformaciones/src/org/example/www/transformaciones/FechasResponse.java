 ...
 */
            ...
            /**
            *  FechasResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FechasResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":fechasResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "fechasResponse",
    ...
    public static class Factory{
        ...
        */
        public static FechasResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FechasResponse object =
                new FechasResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"fechasResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FechasResponse)org.example.www.transformaciones.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

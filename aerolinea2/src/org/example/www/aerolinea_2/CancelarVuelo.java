 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static CancelarVuelo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CancelarVuelo object =
                new CancelarVuelo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"cancelarVuelo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CancelarVuelo)org.example.www.aerolinea_2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
            ...
            /**
            *  DisponibilidadVuelos bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DisponibilidadVuelos
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":disponibilidadVuelos",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "disponibilidadVuelos",
    ...
    public static class Factory{
        ...
        */
        public static DisponibilidadVuelos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DisponibilidadVuelos object =
                new DisponibilidadVuelos();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"disponibilidadVuelos".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DisponibilidadVuelos)org.example.www.aerolinea_2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

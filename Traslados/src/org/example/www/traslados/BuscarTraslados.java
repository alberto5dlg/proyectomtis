 ...
 */
            ...
            /**
            *  BuscarTraslados bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BuscarTraslados
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":buscarTraslados",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "buscarTraslados",
    ...
    public static class Factory{
        ...
        */
        public static BuscarTraslados parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BuscarTraslados object =
                new BuscarTraslados();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"buscarTraslados".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BuscarTraslados)org.example.www.traslados.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

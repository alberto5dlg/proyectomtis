 ...
 */
            ...
            /**
            *  ContratarTraslado bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ContratarTraslado
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":contratarTraslado",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "contratarTraslado",
    ...
    public static class Factory{
        ...
        */
        public static ContratarTraslado parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ContratarTraslado object =
                new ContratarTraslado();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"contratarTraslado".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ContratarTraslado)org.example.www.traslados.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
